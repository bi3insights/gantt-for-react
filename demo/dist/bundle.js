...
var l=__webpack_require__(132),n="function"===typeof Symbol&&Symbol.for,p=n?Symbol.for("react.element"):60103,q=n?Symbol.for("react.portal"):60106,r=n?Symbol.for("react.fragment"):60107,t=n?Symbol.for("react.strict_mode"):60108,u=n?Symbol.for("react.profiler"):60114,v=n?Symbol.for("react.provider"):60109,w=n?Symbol.for("react.context"):60110,x=n?Symbol.for("react.forward_ref"):60112,y=n?Symbol.for("react.suspense"):60113,z=n?Symbol.for("react.memo"):60115,A=n?Symbol.for("react.lazy"):
...
*/
var aa=__webpack_require__(43),n=__webpack_require__(132),r=__webpack_require__(344);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
var _reactAdsense = __webpack_require__(347);

var _reactAdsense2 = _interopRequireDefault(_reactAdsense);

var _Gantt = __webpack_require__(353);
...
var _baidu = __webpack_require__(352);
...
var _frappeGantt = __webpack_require__(355);

var _frappeGantt2 = _interopRequireDefault(_frappeGantt);

var _sizeSensor = __webpack_require__(362);

var _helper = __webpack_require__(368);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__date_utils__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__svg_utils__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bar__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__arrow__ = __webpack_require__(357);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__popup__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__gantt_scss__ = __webpack_require__(359);
...
class Gantt {
    ...
    setup_gantt_dates() {
        ...
        if (this.view_is([VIEW_MODE.QUARTER_DAY, VIEW_MODE.HALF_DAY])) {
            ...
            this.gantt_start = __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].add(this.gantt_start, -2, 'year');
            this.gantt_end = __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].add(this.gantt_end, 2, 'year');
        } else {
        ...
        while (cur_date === null || cur_date < this.gantt_end) {
            if (!cur_date) {
                ...
                if (this.view_is(VIEW_MODE.YEAR)) {
                    cur_date = __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].add(cur_date, 1, 'year');
                } else if (this.view_is(VIEW_MODE.MONTH)) {
                    cur_date = __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].add(cur_date, 1, 'month');
                } else {
                    cur_date = __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].add(
                        cur_date,
                        this.options.step,
                        'hour'
                    );
    ...
    get_date_info(date, last_date, i) {
        ...
        const date_text = {
            'Quarter Day_lower': __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(
                date,
                'HH',
                this.options.language
            ),
            'Half Day_lower': __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(
                date,
                'HH',
                this.options.language
            ),
            Day_lower:
                date.getDate() !== last_date.getDate()
                    ? __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(date, 'D', this.options.language)
                    : '',
            Week_lower:
                date.getMonth() !== last_date.getMonth()
                    ? __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(date, 'D MMM', this.options.language)
                    : __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(date, 'D', this.options.language),
            Month_lower: __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(date, 'MMMM', this.options.language),
            Year_lower: __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(date, 'YYYY', this.options.language),
            'Quarter Day_upper':
                date.getDate() !== last_date.getDate()
                    ? __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(date, 'D MMM', this.options.language)
                    : '',
            'Half Day_upper':
                date.getDate() !== last_date.getDate()
                    ? date.getMonth() !== last_date.getMonth()
                        ? __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(
                              date,
                              'D MMM',
                              this.options.language
                          )
            ...
            Day_upper:
                date.getMonth() !== last_date.getMonth()
                    ? __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(date, 'MMMM', this.options.language)
                    : '',
            Week_upper:
                date.getMonth() !== last_date.getMonth()
                    ? __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(date, 'MMMM', this.options.language)
            ...
            Month_upper:
                date.getFullYear() !== last_date.getFullYear()
                    ? __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(date, 'YYYY', this.options.language)
                    : '',
            Year_upper:
                date.getFullYear() !== last_date.getFullYear()
                    ? __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(date, 'YYYY', this.options.language)
...
class Bar {
    ...
    setup_click_event() {
        ...
        __WEBPACK_IMPORTED_MODULE_1__svg_utils__["a" /* $ */].on(this.group, 'dblclick', (e) => {
            if (this.action_completed) {
                // just finished a move action, wait for a few seconds
                return;
            }
    ...
    show_popup() {
        ...
        const start_date = __WEBPACK_IMPORTED_MODULE_0__date_utils__["a" /* default */].format(
            this.task._start,
            'MMM D',
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__svg_utils__ = __webpack_require__(94);
...
if(false) {
	module.hot.accept("!!../../css-loader/index.js!../../sass-loader/dist/cjs.js!./gantt.scss", function() {
		var newContent = require("!!../../css-loader/index.js!../../sass-loader/dist/cjs.js!./gantt.scss");
...
var _sensorPool = __webpack_require__(363);
...
var _id = _interopRequireDefault(__webpack_require__(364));

var _sensors = __webpack_require__(365);

var _constant = __webpack_require__(137);
...
var _object = __webpack_require__(366);

var _resizeObserver = __webpack_require__(367);
...
var _debounce = _interopRequireDefault(__webpack_require__(136));
